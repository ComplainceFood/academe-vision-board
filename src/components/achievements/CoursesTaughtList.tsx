...
import { Plus, Edit, ExternalLink, Calendar, Users, GraduationCap } from "lucide-react";
...
export const CoursesTaughtList = ({ searchQuery = '' }: { searchQuery?: string } = {}) => {
  ...
  if (isLoading) {
    return <div className="text-center py-8">Loading courses taught...</div>;
  }
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <p className="text-muted-foreground">
          Track courses you've taught, including terms and enrollment numbers.
        </p>
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-semibold mb-2">No courses taught yet</h3>
              <p className="text-muted-foreground mb-4">
                Start tracking courses you've taught across different terms.
              </p>
