            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={analyticsData.trends}>
                  ...
                  <YAxis />
                  <Tooltip />
                  <Line type="monotone" dataKey="notes" stroke="#8884d8" strokeWidth={2} />
                  <Line type="monotone" dataKey="meetings" stroke="#82ca9d" strokeWidth={2} />
                  <Line type="monotone" dataKey="expenses" stroke="#ffc658" strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={300}>
                <AreaChart data={analyticsData.productivity}>
                  ...
                  <Area type="monotone" dataKey="inProgress" stackId="1" stroke="#8884d8" fill="#8884d8" />
